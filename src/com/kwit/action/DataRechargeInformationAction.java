...
@Controller
@Scope("prototype")
public class DataRechargeInformationAction extends BaseAction<DataRechargeInformation>{
	...
	public String uploadPicture(){
		...
		map=dataRechargeInformationService.uploadPictureRecharge(upload,uploadFileName,uploadContentType);
	...
	public String saveRecharge(){		
		...
		map = dataRechargeInformationService.saveRecharge(model);
		setResult(JSONObject.fromObject(map));
		return SUCCESS;
	}
	
	public String getRecharge(){
		jsonList = dataRechargeInformationService.getRecharge(sessionMap.get("socialCreditCode").toString());
		return "jsonList";
	}
	
	public String updateRecharge(){
		Map<String, String> map=new HashMap<String, String>();
		map = dataRechargeInformationService.updateRecharge(model);
		result=JSONObject.fromObject(map);
		return SUCCESS;
	...
	public String deleteRecharge(){
		Map<String, String> map=new HashMap<String, String>();
		map = dataRechargeInformationService.deleteRecharge(model);
		result=JSONObject.fromObject(map);
		return SUCCESS;
